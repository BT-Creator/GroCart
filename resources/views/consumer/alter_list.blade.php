                                    ...
                                    @isset($details, $items)
                                        @foreach($items[$details['id']] as $item)
                                            <section class="list-item" draggable="true">
                                                ...
                                                @isset($item['note'])
                                                    <p><span
                                                            class="list-property">Note:</span>{{str_replace('_', ' ', $item['note'])}}
                                                    </p>
                                                @endisset
                            ...
                            <section>
                                ...
                                <label for="store_number">
                                    ...
                                    @isset($details['store_house_number'])
                                        <input type="text" name="store_number" required="required" id="store_number"
                                               placeholder="House number" value="{{$details['store_house_number']}}"
                                               maxlength="6">
                                    @else
                                        <input type="text" name="store_number" required="required" id="store_number"
                                ...
                                <label for="store_postal_code">
                                    ...
                                    @isset($details['store_postal_code'])
                                        <input type="text" name="store_postal_code" required="required"
                                               id="store_postal_code"
                                               placeholder="Postal Code" value="{{$details['store_postal_code']}}"
                                               maxlength="8">
                                    @else
                                        <input type="text" name="store_postal_code" required="required"
                                               id="store_postal_code"
                            ...
                            <section>
                                ...
                                <label for="delivery_street">
                                    ...
                                    @isset($details['delivery_street'])
                                        <input type="text" placeholder="Street" name="delivery_street"
                                               required="required"
                                               id="delivery_street" value="{{$details['delivery_street']}}"
                                               maxlength="64">
                                    @else
                                        <input type="text" placeholder="Street" name="delivery_street"
                                               required="required"
                                ...
                                <label for="delivery_number">
                                    ...
                                    @isset($details['delivery_house_number'])
                                        <input type="text" name="delivery_number" required="required"
                                               id="delivery_number"
                                               placeholder="Number" value="{{$details['delivery_house_number']}}"
                                               maxlength="6">
                                    @else
                                        <input type="text" name="delivery_number" required="required"
                                               id="delivery_number"
                                ...
                                <label for="delivery_postal_code">
                                    ...
                                    @isset($details['delivery_postal_code'])
                                        <input type="text" name="delivery_postal_code" required="required"
                                               id="delivery_postal_code"
                                               placeholder="Postal Code" value="{{$details['delivery_postal_code']}}"
                                               maxlength="8">
                                    @else
                                        <input type="text" name="delivery_postal_code" required="required"
                                               id="delivery_postal_code"
                                ...
                                <label for="delivery_country">
                                    ...
                                    @isset($details['delivery_country'])
                                        <input type="text" name="delivery_country" required="required"
                                               id="delivery_country"
                                               placeholder="Country" value="{{$details['delivery_country']}}"
                                               maxlength="64">
                                    @else
                                        <input type="text" name="delivery_country" required="required"
                                               id="delivery_country"
